...
This project is indexed by GitNexus as **neurophysics** (1765 symbols, 3489 relationships, 140 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
