...
This project is indexed by GitNexus as **neurophysics** (1904 symbols, 3861 relationships, 152 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
