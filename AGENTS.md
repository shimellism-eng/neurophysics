...
This project is indexed by GitNexus as **neurophysics** (1752 symbols, 3473 relationships, 139 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
