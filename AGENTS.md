...
This project is indexed by GitNexus as **neurophysics** (1716 symbols, 3431 relationships, 136 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
