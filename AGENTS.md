...
This project is indexed by GitNexus as **neurophysics** (1848 symbols, 3713 relationships, 148 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
