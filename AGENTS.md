...
This project is indexed by GitNexus as **neurophysics** (1960 symbols, 3960 relationships, 157 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
