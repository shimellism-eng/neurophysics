...
This project is indexed by GitNexus as **neurophysics** (1941 symbols, 3916 relationships, 155 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
