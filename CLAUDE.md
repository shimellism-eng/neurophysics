...
This project is indexed by GitNexus as **neurophysics** (1955 symbols, 3956 relationships, 157 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
