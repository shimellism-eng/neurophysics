...
This project is indexed by GitNexus as **neurophysics** (1768 symbols, 3497 relationships, 141 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
