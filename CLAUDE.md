...
This project is indexed by GitNexus as **neurophysics** (1916 symbols, 3876 relationships, 153 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
