...
This project is indexed by GitNexus as **neurophysics** (1953 symbols, 3951 relationships, 156 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
