...
export const FORCES_TOPICS = {
  ...
  newtons_laws: {
    ...
    description: "Newton's 1st: object at rest stays at rest, object moving stays moving at constant velocity, unless acted on by a resultant force (inertia). 2nd: F = ma (resultant force = mass × acceleration). Inertial mass is a measure of how hard it is to accelerate an object — it is defined by F = ma, rearranged as m = F/a. Gravitational mass determines the force due to gravity (W = mg). These are found to be equal, which is why all objects fall at the same rate in a vacuum. 3rd: every action force has an equal and opposite reaction force acting on a different object.",
    ...
    misconception: 'Inertial mass and gravitational mass are different concepts but have the same value. In a vacuum, all objects fall at the same rate regardless of mass.',
    concept: 'F = 1200 × 3 = 3600 N. Inertial mass (m = F/a) measures resistance to acceleration. Gravitational mass determines weight (W = mg). Both are equal — hence all objects fall at g = 9.8 m/s² in a vacuum.',
  },
  stopping_distance: {
