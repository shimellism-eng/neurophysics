  ...
  key_concepts_units: {
    ...
    lessonKeywords: [
      ...
      },
      {
        ...
        symbol: '',
        unit: '',
        definition: 'A symbol placed before a unit to scale it by a power of 10.',
      ...
      },
      {
        ...
        symbol: 'A × 10ⁿ',
        unit: '',
        definition: 'A way of writing numbers as A × 10ⁿ where 1 ≤ A < 10 and n is an integer.',
      ...
      },
      {
        ...
        symbol: 's.f.',
        unit: '',
        definition: 'The number of meaningful digits in a measured or calculated value, indicating precision.',
        everydayNote: 'Measuring 12.4 cm (3 s.f.) is more precise than 12 cm (2 s.f.) — it tells you more about the actual value.',
      },
    ],
