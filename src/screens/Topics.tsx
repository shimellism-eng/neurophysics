...
const ALL_TOPICS = [
  ...
  { id: 'magnetism',   name: 'Magnetism',          Icon: IconMagnetism,   color: 'var(--topic-magnetism)',   paper: 'Paper 2', concepts: ['permanent-temporary-magnets','magnetic-fields','electromagnetism','motor-effect','flemings-left-hand-rule','generators-and-induction','transformers'],                                                                                                    available: false },
  { id: 'particles',   name: 'Particle Model',     Icon: IconParticles,   color: 'var(--topic-particles)',   paper: 'Paper 1', concepts: ['states-of-matter','particle-model','density','changes-of-state','internal-energy','specific-heat-capacity','specific-latent-heat'],                                                                                                                      available: false },
  { id: 'atomic',      name: 'Atomic Structure',   Icon: IconAtomic,      color: 'var(--topic-nuclear)',     paper: 'Paper 2', concepts: ['atomic-structure','isotopes','radioactive-decay','alpha-beta-gamma','half-life','uses-of-radiation','nuclear-fission-fusion'],                                                                                                                            available: false },
  { id: 'space',       name: 'Space Physics',      Icon: IconSpace,       color: 'var(--topic-space)',       paper: 'Paper 2', concepts: ['solar-system','life-cycle-of-stars','orbital-motion','red-shift','big-bang','dark-matter-energy','satellites'],                                                                                                                                          available: false },
];
